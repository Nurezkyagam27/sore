# -*- coding: utf-8 -*-
# 🌿 STREAMLIT APP - HERBAL LEAF CLASSIFIER
...
# ==================== UI ====================
st.title("🌿 Klasifikasi Daun Herbal Indonesia (MobileNetV2)")

uploaded_file = st.file_uploader(
    "Upload gambar daun herbal",
    type=["jpg", "png", "jpeg"]
)
...
if uploaded_file is not None:
    ...
    df = pd.DataFrame(preds[0] * 100, index=CLASS_NAMES, columns=["Probabilitas (%)"])
    st.bar_chart(df)
    ...
    st.info("👆 Upload gambar daun herbal untuk memulai klasifikasi.")
